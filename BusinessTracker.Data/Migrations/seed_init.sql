...
VALUES ('Администратор', 'admin123')
ON CONFLICT ("Id") DO NOTHING;

-- Seed data for Categories
INSERT INTO "Categories" ("Id", "Name", "OwnerId")
VALUES ('c1eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Продукты питания', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11')
ON CONFLICT ("Id") DO NOTHING;

-- Seed data for Nomenclatures
INSERT INTO "Nomenclatures" ("Id", "Name", "CategoryId")
VALUES ('d1eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Хлеб пшеничный', 'c1eebc99-9c0b-4ef8-bb6d-6bb9bd380a11')
ON CONFLICT ("Id") DO NOTHING;
